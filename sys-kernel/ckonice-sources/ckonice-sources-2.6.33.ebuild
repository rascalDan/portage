...
DESCRIPTION="Con Kolivas' high performance patchset + TuxOnIce + Gentoo patchset sources"
...
UNIPATCH_LIST="${DISTDIR}/patch-${PV}-ck${CK_VERSION}.bz2 ${DISTDIR}/${TUXONICE_SRC}.bz2"
